...
const _nljDjFxvmzWX43SJQbd1rZfhAV5dEUvCDMkEPakSxOM = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _nljDjFxvmzWX43SJQbd1rZfhAV5dEUvCDMkEPakSxOM
];
...
const handlers = [
  ...
  { route: '/**', handler: _lazy_xeJvW8, lazy: true, middleware: false, method: undefined }
];
