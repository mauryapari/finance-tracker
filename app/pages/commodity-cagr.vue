<template>
  <div class="flex flex-col h-full px-4">
    <div class="flex items-center py-3 border-b border-gray-100 dark:border-gray-700 flex-shrink-0">
      <h3 class="font-semibold text-gray-700 dark:text-gray-200 text-base">Commodity CAGR</h3>
    </div>
    <DataTable
      :value="derivedCommodityCagrEntries"
      dataKey="id"
      showGridlines
      scrollable
      scrollHeight="flex"
    ...
    >
      ...
      <Column sortable field="investmentOrOut" header="Type" style="min-width:8rem" />
    </DataTable>
  </div>
</template>
